...
@section('content')
    <div class="container-fluid" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 0.9rem;">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('products.types.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="product_type_name" id="product_type_name"
                                class="form-control form-control-sm" placeholder="Enter product type name" required>
                    ...
                    <div class="mt-4 d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">Save Product Type</button>
                    </div>
